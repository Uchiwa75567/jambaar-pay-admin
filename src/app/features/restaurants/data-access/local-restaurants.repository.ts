...
export class LocalRestaurantsRepository implements RestaurantsRepository {
  ...
  upsert(restaurant: Restaurant): Observable<Restaurant> {
    ...
    this.datasetStorage.writeArray(RESTAURANTS_STORAGE_KEY, Array.from(restaurantsById.values()));
    return of(restaurant);
  }

  private readAll(): Restaurant[] {
